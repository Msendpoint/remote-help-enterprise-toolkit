<#
.SYNOPSIS
    One-click installer and launcher for Remote Help Enterprise Management Toolkit
...
Write-Host "    Remote Help Enterprise Management Toolkit" -ForegroundColor Cyan
...
$mainScript = Join-Path $scriptDir "scripts/remote-help-enterprise-toolkit.ps1"
